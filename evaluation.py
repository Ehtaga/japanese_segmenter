...
def main(argv):
    ...
    for i in range(len(system_set.raw_sentences)):
        ...
        number_of_cont_detected = 0.0
        number_of_cont_to_find = 0.0
        number_of_correct_cont = 0.0
        ...
        for j in range(1, len(annotated_system_sentence), 2):
            ...
            if annotated_system_sentence[j] == 'c':
                number_of_cont_detected += 1.0
                if annotated_reference_sentence[j] == 'c':
                    number_of_correct_cont += 1.0
            if annotated_reference_sentence[j] == 'c':
                number_of_cont_to_find += 1.0
        ...
        if (number_of_boundaries_detected+number_of_cont_detected) != 0:
            accuracies.append((number_of_correct_boundaries+number_of_correct_cont)/(number_of_boundaries_detected+number_of_cont_detected))
